...
/** Icon button that copies `value` to the clipboard and shows a "Copied" tooltip. */
export const CopyToClipboardButton = (props: CopyToClipboardButtonProps) => {
	...
	return (
		<Tooltip arrow disableHoverListener open={copied} placement="top" title="Copied">
			<IconButton {...restProps} onClick={copyToClipboard} data-class="copy-button">
				{size === "normal" && (
					<svg
						height="20"
						viewBox="0 0 20 20"
